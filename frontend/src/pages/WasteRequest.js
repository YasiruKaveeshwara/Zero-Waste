      ...
      <div className="main-content-request">
        <div className="large-container">
          ...
          <div className="banner-section">
            ...
            <p>
              Make a difference by managing your waste responsibly and
              ...
              <form onSubmit={handleFormSubmit} className="waste-request-form">
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleFieldChange("wasteType", e.target.value)
                    }
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  <DatePicker
                    ...
                    onChange={(date) =>
                      handleFieldChange("collectionDate", date)
                    }
                ...
                <div className="form-group">
                  <label htmlFor="collectionCenter">

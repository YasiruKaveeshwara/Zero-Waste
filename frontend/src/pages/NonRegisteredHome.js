  ...
  const slides = [
    {
      ...
      description:
        "Discover our services and how we manage waste to keep our planet clean and green."
    },
    {
      image: SliderImage1,
      title: "Join the Zero Waste Movement",
      description:
        "Become part of the solution. Reduce, Reuse, Recycle, and help create a sustainable future."
    },
    {
      image: SliderImage2,
      title: "Recycle More, Waste Less",
      description:
        "Explore ways you can reduce your waste footprint with our tips and resources."
    }
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "By managing waste responsibly, you can help reduce harmful emissions and pollution."
    },
    {
      icon: ConserveIcon,
      ...
      description:
        "Recycling and reusing materials conserves natural resources for future generations."
    },
    {
      icon: SupportIcon,
      ...
      description:
        "Every action you take contributes to a healthier and greener planet."
    },
    {
      icon: SaveMoneyIcon,
      alt: "Save Money Icon",
      title: "Save Money",
      description:
        "By reducing waste, you can also lower disposal costs and save on purchasing new materials."
    }
  ];
    ...
    <div className="non-registered-home">
      <header className="nonreg-header">
        ...
        <nav className="nonreg-navbar">
          <a href="/resident-nonreghome" className="nonreg-nav-link">
            Home
          </a>
          <a href="/history" className="nonreg-nav-link">
            About
          </a>
          <a href="#contact" className="nonreg-nav-link">
            Contact Us
          </a>
          <a href="/resident-signup" className="nonreg-nav-link">
            Sign Up
          </a>
